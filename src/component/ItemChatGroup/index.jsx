import { IconChatGrup1, IconChatGrup2} from "../../assets/icons";

export default function ItemChatGroup() {
  return (
    <>
    {/* Item Chat Grup */}
    <div className="mt-[26px] mb-[28px] flex">
            ...
            <div className="flex relative">
              ...
              <img
                src={IconChatGrup2}
                alt="asd"
                className="w-[34px] h-[34px] absolute left-[10px] z-[2]"
              />
            </div>
            {/* RIght Content */}
            <div>
              ...
              <div className="ml-[20px] ">
                <div
                  className="text-[12px] flex gap-[16px]"
                >
